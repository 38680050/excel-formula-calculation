...
/**
 * description: excel实体类（UUID）
 *
 * @author chenhaoxuan
 * @version 1.0
 * @date 2018/10/18 15:40
 */
public class ExcelUUID {

    @ExcelField(value = ExcelFieldTypeEnum.ID, idType = ExcelIdTypeEnum.UUID)
    private String id;
    @ExcelField
    private String A;
    @ExcelField
    ...
    public ExcelUUID(String id, String a, String b, String c, String d, String e, String f, String g, String h, String i, String j, String k, String l, String m, String n, String cellTypes, String sheet, Integer sort) {
        this.id = id;
        A = a;
        B = b;
        C = c;
